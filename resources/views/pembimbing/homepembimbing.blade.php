...
@section('content')
    ...
    <div class=" mt-5">
        <div class="card col-12 shadow mx-auto p-4">
            <h5 class="fw-bold mb-4">Data Pembimbing</h5>
            <div class="row mb-3">
                <div class="col-12">
                    <div id="toggleImport" class="btn btn-warning text-white">
                        <i class="bi-cloud-download-fill"></i> Import
                    </div>
                        <a href="{{ route('exportDataPembimbing') }}" class="btn btn-success"> <i class="bi bi-file-earmark-excel"></i> Export</a>
                        ...
                        <table class="table table-bordered" id="example" style="font-size: 12px">
                            ...
                            <tbody>
                                @foreach ($pembimbing as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('hapuspembimbing', $item->id) }}"
                                    ...
                                    @include('pembimbing.detailpembimbing')
                                    @include('pembimbing.editpembimbing')
                                    @include('pembimbing.hapuspembimbing')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
    ...
    @include('pembimbing.tambahpembimbing')
