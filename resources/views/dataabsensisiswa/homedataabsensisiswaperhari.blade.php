...
@section('title', 'Home Absensi Siswa Hari Ini')

@section('content')
    <div class=" mt-5 mb-5">

        <div class="card col-12 shadow mx-auto p-4">
            <h5 class="fw-bold mb-4">Data Absensi Siswa Hari Ini</h5>
            {{-- <div class="row mb-2">
                        ...
                        <table class="table table-sm table-striped table-bordered" id="example" style="font-size: 10px">
                            ...
                            <tbody>
                                @foreach ($absensisiswa as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('hapusdataabsensisiswaperhari', $item->id) }}"
                                    ...
                                    @include('dataabsensisiswa.editdataabsensisiswaperhari')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
