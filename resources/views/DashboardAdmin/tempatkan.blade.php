...
<div class="card p-3 col-12 shadow">
    <div class="card-body">
        <form action="{{ route('posttambahmenempati') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <label for="" class="mb-2 fw-bold" style="color: rgb(19, 19, 59)">Siswa</label>
                    <input type="text" readonly  class="form-control form-control-lg mb-3 " id="siswa" name="siswa_ids[]" value="{{ $siswa->id }}" placeholder="{{ $siswa->nama }}" >
